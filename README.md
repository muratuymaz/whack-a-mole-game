...
## 1. Proje Hakkında
**Whack-a-Mole**, C++ programlama dili ve SDL2 kütüphanesi kullanılarak geliştirilmiş, reflekslere ve hız dayalı tek oyunculu bir arcade oyunudur. Oyuncu, 3x3'lük bir ızgarada (toplam 9 delik) rastgele beliren köstebeklere 15 saniyelik kısıtlı süre içerisinde fare ile tıklayarak en yüksek skoru elde etmeye çalışır.
...
| **Grafik Kütüphanesi** | SDL2 | Pencere, görüntü çizimi (SDL2_image) ve fontlar (SDL2_ttf) |
...
* SDL2, SDL2_image ve SDL2_ttf kütüphanelerinin sisteme tanımlı olması
...
* assets/: Oyun içi varlıklar (Dokular/Textures, Fontlar, Skor TXT dosyası).
